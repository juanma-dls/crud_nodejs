...
export class deliveryAddres1664577636670 implements MigrationInterface {
    name = 'deliveryAddres1664577636670'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "temporary_orders" ("id" varchar PRIMARY KEY NOT NULL, "numOrder" varchar NOT NULL, "description" varchar(200) NOT NULL, "product_id" varchar NOT NULL, "applicant_id" varchar NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "updated_at" datetime NOT NULL DEFAULT (datetime('now')), "dateOrder" datetime NOT NULL, "deliveryAddres" varchar NOT NULL, CONSTRAINT "UQ_c0fddfa1dc4b70a19a051cf10c2" UNIQUE ("numOrder"), CONSTRAINT "FK_b3b3508cdbdfd868a5a7909e3a7" FOREIGN KEY ("applicant_id") REFERENCES "applicants" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_ac832121b6c331b084ecc4121fd" FOREIGN KEY ("product_id") REFERENCES "products" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "orders" ("id" varchar PRIMARY KEY NOT NULL, "numOrder" varchar NOT NULL, "description" varchar(200) NOT NULL, "product_id" varchar NOT NULL, "applicant_id" varchar NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "updated_at" datetime NOT NULL DEFAULT (datetime('now')), "dateOrder" datetime NOT NULL, CONSTRAINT "UQ_c0fddfa1dc4b70a19a051cf10c2" UNIQUE ("numOrder"), CONSTRAINT "FK_b3b3508cdbdfd868a5a7909e3a7" FOREIGN KEY ("applicant_id") REFERENCES "applicants" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_ac832121b6c331b084ecc4121fd" FOREIGN KEY ("product_id") REFERENCES "products" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
